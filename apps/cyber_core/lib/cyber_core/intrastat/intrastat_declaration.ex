defmodule CyberCore.Intrastat.IntrastatDeclaration do
  use Ecto.Schema
  ...
  schema "intrastat_declarations" do
    ...
    has_many :lines, CyberCore.Intrastat.IntrastatDeclarationLine
  ...
  def changeset(declaration, attrs) do
    ...
    |> unique_constraint([:tenant_id, :year, :month, :flow])
  end
end
