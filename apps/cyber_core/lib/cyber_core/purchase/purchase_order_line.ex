defmodule CyberCore.Purchase.PurchaseOrderLine do
  @moduledoc """
  Редове на поръчка за покупка.
  """
  use Ecto.Schema
  ...
  schema "purchase_order_lines" do
    ...
    field :quantity_ordered, :decimal
    field :quantity_received, :decimal, default: Decimal.new(0)
  ...
  def changeset(line, attrs) do
    ...
    |> validate_number(:quantity_ordered, greater_than: 0)
    |> validate_number(:quantity_received, greater_than_or_equal_to: 0)
  ...
  defp calculate_amounts(changeset) do
    quantity = get_field(changeset, :quantity_ordered)
