defmodule CyberCore.Purchase.SupplierInvoiceLine do
  @moduledoc """
  Редове на фактура от доставчик.
  """
  use Ecto.Schema
  import Ecto.Changeset

  schema "supplier_invoice_lines" do
    field :tenant_id, :integer

    # Връзки
    belongs_to :supplier_invoice, CyberCore.Purchase.SupplierInvoice
